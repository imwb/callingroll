...
public class ButtonRectangle extends Button {
	...
	public ButtonRectangle(Context context, AttributeSet attrs, TextView textButton) {
		super(context, attrs);
...
//		centrarTexto();
		super.onDraw(canvas);
		if (x != -1) {
			Rect src = new Rect(0, 0, getWidth()-Utils.dpToPx(4, getResources()), getHeight()-Utils.dpToPx(4, getResources()));
